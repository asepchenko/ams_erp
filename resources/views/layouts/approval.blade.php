...
<head>
    ...
    <title>AMS - Approval System</title>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item active" href="{{ route("approval.dashboard.index") }}">Approval</a>
        ...
        <div class="content-wrapper" style="min-height: 917px;">
            ...
            <section class="content text-sm" style="padding-top: 20px">
              <div class="callout callout-danger">
                    ...
                    <p>
                    Tombol <b>Open Budget</b> pada pengajuan document untuk yang budgetnya sudah habis dibulan berjalan.<br>
                      digunakan hanya untuk memakai budget bulan berikutnya dgn melampirkan BA ttd atasan / manager.</p>
              </div>
                @include('alert')
