...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-8">
        <h1 class="m-0 text-dark">Report Detil Realisasi </h1>
      </div><!-- /.col -->
      <div class="col-sm-4">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Budgeting</a></li>
          <li class="breadcrumb-item"><a href="#">Report</a></li>
          <li class="breadcrumb-item active">Detil Realisasi</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
                        ...
                        <thead>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><b>{{ number_format($totalrealisasi,0) }} </b></td>
...
$(document).ready(function(){
    ...
    $('#btnFiterSubmitSearch').click(function(){
        ...
        spinner.show();
        window.location.href = "{{ url('budget/reportrealisasi') }}"+ "/search/" +  start_period + "/" +  end_period + "/" + tahun + "/" + group + "/" + status + "";
    });
