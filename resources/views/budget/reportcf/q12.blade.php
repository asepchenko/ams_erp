                            ...
                            @endforeach
                                ...
                                @foreach($datanya as $key => $data)
                                    <tr>
                                     ...
                                     <td><b><a href="{{url('budget/reportcfdetil')}}/search/{{ $data->urutan }}/{{ $tahun }}/1" 
                                            style="color:black" target="_blank"> {{ number_format($data->realisasi_01,0) }}</a><b></td>
                                        <td> {{ number_format($data->budget_02,0) }}</td>
                                     <td><b><a href="{{url('budget/reportcfdetil')}}/search/{{ $data->urutan }}/{{ $tahun }}/2" 
                                            style="color:black" target="_blank"> {{ number_format($data->realisasi_02,0) }}</a><b></td>
                                        <td> {{ number_format($data->budget_03,0) }}</td>
                                     <td><b><a href="{{url('budget/reportcfdetil')}}/search/{{ $data->urutan }}/{{ $tahun }}/3" 
                                            style="color:black" target="_blank"> {{ number_format($data->realisasi_03,0) }}</a><b></td>
                                    </tr>
                                @endforeach
                            </tbody>
          </table>
