...
<div class="row">
    <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <form class="form-horizontal" id="formdocument" action="{{ route("budget.anggaran.update", [$data->id]) }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nilai_realisasi" id="nilai_realisasi" class="form-control" value="{{ $data->nilai_realisasi }}" required >
                            </div>
                        </div>
                        @endif
        ...
        <!-- Tambahan Ache u/ List Lampiran file -->
        <div class="card">
...
$(document).ready(function(){
    ...
    $('#table_budget').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ url('budget/anggaran/databudget') }}"+'/'+'{{ $data->id }}',
        columns: [
            //{ data: 'id', name: 'id' },
    ...
    $('#data_file').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ url('budget/anggaran/data-file') }}"+'/'+'{{ $data->id }}',
        columns: [
