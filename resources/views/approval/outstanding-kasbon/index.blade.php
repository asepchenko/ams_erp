...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Kasbon Outstanding List</h1>
            </div><!-- /.col -->
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Approval</a></li>
            <li class="breadcrumb-item"><a href="#">Kasbon Document</a></li>
...
$(document).ready(function(){
    ...
    var table = $('#table_proses').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: "{{ url('approval/outstanding-kasbonproses') }}",
          type: 'GET',
          data: function (d) {
        ...
        columns: [
            { data: 'id', name: 'id' },
            { data: 'document_kb', name: 'document_kb' },
            { data: 'document_kbt', name: 'document_kbt' },
    ...
    var table = $('#table_data').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: "{{ url('approval/outstanding-kasbon') }}",
          type: 'GET',
          data: function (d) {
          d.bulan = $("#bulan option:selected").val()
          }
        ...
        columns: [
            ...
            { data: 'id', name: 'id' },
            { data: 'document_kb', name: 'document_kb', orderable: false },
            { data: 'document_kbt', name: 'document_kbt', orderable: false },
            { data: 'no_ref', name: 'no_ref' },
            { data: 'priority_name', name: 'priority_name' },
            { data: 'created_at', name: 'created_at' },
            { data: 'nama', name: 'nama' },
