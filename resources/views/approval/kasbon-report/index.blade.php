...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Kasbon Report</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Approval</a></li>
          <li class="breadcrumb-item"><a href="#">Report</a></li>
          <li class="breadcrumb-item active">Kasbon Report</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" name="dept" id="dept" data-dependent="nama">
...
$(document).ready(function(){
    ...
    $('#btnFiterSubmitSearch').click(function(){
        ...
        spinner.show();
        window.location.href = "{{ url('approval/kasbon-report') }}"+ "/search/" + bulan + "/" + status + "/" + dept + "/" + nama + "";
    });
});
</script>
@endsection