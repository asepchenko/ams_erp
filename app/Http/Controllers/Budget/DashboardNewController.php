...
class DashboardNewController extends Controller
{
    public function index(Request $request)
    {
        ...
        $datapie_ams = DB::select('select kode, CAST(nilai AS DECIMAL(18,0)) as nilai
            from (select a.tahun, a.Budget, a.Progress, a.Realisasi, (Budget - Progress - Realisasi) as Sisa from budget.dbo.v_report_amsbudget2024 a)  awal
            unpivot (
        ...
        $datapie_acc = DB::select('select kode, CAST(nilai AS DECIMAL(18,0)) as nilai
            from (select a.tahun, a.kode_group,  a.Budget, a.Progress, a.Realisasi, (Budget - Progress - Realisasi) as Sisa from budget.dbo.v_report_dashboard2024 a)  awal
            unpivot (
                nilai for kode IN (Budget, Realisasi, Progress, Sisa
                )
